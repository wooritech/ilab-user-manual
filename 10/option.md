...
* [서비스 연결 설정](option.md#서비스-연결-설정)
  * [서버주소](option.md#서버주소)
  * [아이디, 패스워드](option.md#아이디-패스워드)
* [개인별 설정](option.md#개인별-설정)
  * [개인설정](option.md#개인설정)
  * [사인 이미지](option.md#사인-이미지)
* [기관별 설정](option.md#기관별-설정)
  * [완료 예정일](option.md#완료-예정일)
  * [접수화면별 필수 입력값 설정](option.md#접수화면별-필수-입력값-설정)
  * [자동 암호 묻기 시간](option.md#자동-암호-묻기-시간)
  * [암호 규칙](option.md#암호-규칙)
  * [성적서 출력](option.md#성적서-출력)
  * [SMS 옵션](option.md#sms-옵션)
