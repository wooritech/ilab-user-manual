...
![](../.gitbook/assets/72%20%282%29.png)

![](../.gitbook/assets/73%20%283%29.png)
...
| boolean | 무, 유\(거짓, 참\) 을 선택하여 입력 받는 변수\(고정입니다.\) | ![](../.gitbook/assets/85boolean%20%281%29.png) |
| :--- | :--- | :--- |
| date | 날짜값을 입력 받습니다.화면 우측에 있는 기본값에 today로 입력한다면 해당 시험법이 연결된 항목이 접수 될 때의 일자가 입력됩니다. | ![](../.gitbook/assets/87date%20%281%29.png) |
...
| extended | 실수형 값을 입력 받는 변수 | ![](../.gitbook/assets/89string_extended_integer_%20%281%29.png) |
| integer | 정수형 값을 입력 받는 변수 | ![](../.gitbook/assets/90string_extended_integer_%20%281%29.png) |
...
* 선택 옵션에 입력한 값 중에서 항목 조회 시 최초로 선택이 되길 원하는 값이 있다면,
  ...
  ![](../.gitbook/assets/104picklist-2%20%281%29.png)
...
| 예1\)· 좌변 = 우변 설명화면에서 입력한 V2값을 V1에 자동으로 대입합니다.화면에서 V2에 2를 입력한 것으로 가정합니다.· 계산과정계산식 =&gt; V1 = V2          Result = V1 \* 10최종결과값은 20입니다. | ![](../.gitbook/assets/111%20%281%29.png) |
| :--- | :--- |
...
![](../.gitbook/assets/120-2%20%281%29.png)

![](../.gitbook/assets/121-3%20%281%29.png)
