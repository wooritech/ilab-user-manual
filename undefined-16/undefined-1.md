...
![](../.gitbook/assets/01list_index_%20%282%29.png)
...
2. 사용자 계정 선택
   ...
   ![](https://github.com/wooritech/ilab-user-manual/tree/dc2557ca13b72c21cc07884c110e4e7920bff543/assets/faq/000-02/02사용자계정선택.png)

   ＊ 사용자 계정 메뉴를 찾기가 어려우시다면 제어판 우측 상단에 있는 보기기준을 변경하여 찾아보시기 바랍니다.

   ![](../.gitbook/assets/03%20%2821%29.png)

3. 사용자 계정 컨트롤 설정 변경 클릭.

   ![](https://github.com/wooritech/ilab-user-manual/tree/dc2557ca13b72c21cc07884c110e4e7920bff543/assets/faq/000-02/04사용자계정컨트롤.png)
...
2. 디스플레이 선택
   ...
   ![](https://github.com/wooritech/ilab-user-manual/tree/dc2557ca13b72c21cc07884c110e4e7920bff543/assets/faq/000-02/07디스플레이.png)

   ＊ 디스플레이 메뉴를 찾기가 어려우시다면 제어판 우측 상단에 있는 보기기준을 변경하여 찾아보시기 바랍니다.

   ![](../.gitbook/assets/08%20%2835%29.png)

3. 선택되어있는 폰트 크기가 크게 또는 중간으로 선택되어있다면 작게로 변경.

   ![](../.gitbook/assets/09%20%2828%29.png)
...
5. 로그오프 선택 창이 팝업되면 지금 로그오프를 해주세요.
   ...
   ![](../.gitbook/assets/11%20%2820%29.png)
...
1. 윈도우 우측 하단에 시간이 나온 부분을 클릭.
   ...
   ![](../.gitbook/assets/13-1%20%283%29.png)
...
3. 팝업되는 창에서 한번더 날짜 및 시간 설정 변경버튼 클릭.
   ...
   ![](../.gitbook/assets/15-_-_-_-1%20%281%29.png)
